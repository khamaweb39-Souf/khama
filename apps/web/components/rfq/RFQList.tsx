...
const MOCK_RFQS = [
  {
    id: 'RFQ-2026-001',
    title: 'مطلوب 5000 متر قماش بوبلين قطني ناعم لقمصان رجالي',
    buyer: 'مصنع الأناقة العاصمي',
    ...
    responses: 14,
    urgent: true,
    composition: '100% قطن عضوي',
    gsm: '120'
  },
  {
    id: 'RFQ-2026-002',
    title: 'توريد جلد ماعز مدبوغ (Nappa) لصناعة الحقائب',
    buyer: 'ورشة إبداع للجلود',
    category: 'جلود طبيعية',
    quantity: '2500',
    unit: 'قدم مربع',
    ...
    responses: 6,
    urgent: false,
    composition: 'جلد طبيعي 100%',
    gsm: 'N/A'
  },
  {
    id: 'RFQ-2026-003',
    title: 'خيوط بوليستر عالية المتانة لإنتاج ملابس العمل',
    buyer: 'تجهيزات الحماية المهنية',
    category: 'خيوط تقنية',
    quantity: '1000',
    unit: 'بكرة',
    ...
    responses: 4,
    urgent: true,
    composition: '100% بوليستر معاد تدويره',
    gsm: 'N/A'
  },
  {
    id: 'RFQ-2026-004',
    title: 'قماش جينز (Denim) وزن 12 أوز للإنتاج الشتوي',
    buyer: 'شركة بلو-جينز تونس',
    category: 'أقمشة ثقيلة',
    quantity: '8000',
    unit: 'متر',
    location: 'القيروان، تونس',
    deadline: '4 أيام',
    responses: 22,
    urgent: false,
    composition: '98% قطن، 2% ليكرا',
    gsm: '400'
  }
];
